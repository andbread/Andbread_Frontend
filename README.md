...
### 🚀 배포 이후에도 지속적으로 개선하고 있어요.

엔빵은 1차 배포 이후 실제 사용자 피드백과 운영 과정에서 발견된 개선 사항을 수집하며 서비스를 발전시켜 나가고 있습니다.

알림 기능 추가, 초대 방식 개선, 정산 관리 기능 보완 등 사용자 경험을 향상시키기 위한 기능들을 지속적으로 업데이트하고 있으며, 앞으로도 실제 사용자의 의견을 바탕으로 서비스를 개선해 나갈 예정입니다.
...
[➡️ 엔빵 배포된 사이트 바로가기](https://www.nbread.co.kr/)

[➡️ 엔빵 소개 페이지 바로가기](https://shinhm1.notion.site/1b2e7e8fdd128042a4e4c33ab622184d)
...
엔빵은 1차 배포 이후 사용자 피드백과 실제 운영 과정에서 확인된 개선 사항을 바탕으로 서비스를 지속적으로 개선하고 있습니다.
...
| `v1.4` | 엔빵 데이터 관련 수정사항 반영 | 2025.03.13 |

| 버전   | 업데이트 내용          | 일자       |
| ------ | ---------------------- | ---------- |
| `v2.0` | 1차 수집 개선사항 반영 | 2026.05.18 |
| `v2.1` | 엔빵 서비스 2차 배포   | 2026.06.12 |
...
> 2026년 이후부터는 개인 프로젝트로 전환해 서비스를 개선해 나가고 있습니다. (@hm1n)
...
| 25.04.01 ~ 25.04.31 | 서비스 개선 사항 기반 개선안 기획                |
| 25.05.01 ~ 25.11.01 | 알림, 친구, 채팅, 게시판 기능 등 신규 기능 구현  |

| 기간                | 일정                              |
| ------------------- | --------------------------------- |
| 26.05.01 ~ 26.05.31 | 친구 초대, 채팅 등 기존 기능 개선 |
| 25.06.12 ~          | 서비스 2차 배포 및 운영           |
