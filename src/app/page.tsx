...
export default function LandingPage() {
  return (
    <>
      <JsonLdScript data={landingPageJsonLd} />
        ...
        <section className="overflow-hidden px-24 pb-0 pt-36">
          ...
          <RevealOnScroll className="mt-54">
            ...
            <p className="mt-28 break-keep text-[16px] font-normal leading-[26px] text-gray-600">
              넷플릭스, 유튜브 프리미엄, 왓챠 등 친구, 가족과 나누는 구독
              서비스의 결제일과 정산 현황을 한 곳에서 관리할 수 있어요.
            </p>
          </RevealOnScroll>
              ...
              <div key={point.title} className={index === 0 ? '' : 'mt-24'}>
                <div className="flex items-center gap-8">
                  <Icon
                    ...
                    ariaHidden
                  />
                  <h3 className="text-heading04 text-gray-800">
                    {point.title}
                  </h3>
                </div>
          ...
          >
            {steps.map((step, index) => (
              <div key={step.label} className={index === 0 ? '' : 'mt-28'}>
                <p className="text-heading05 text-secondary-300">
                  {step.label}
                </p>
